...
static constexpr int8_t PIN_FPGA_CRESETN = 27; // FPGA CRESET_B (active low) - corrected per schematic
static constexpr int8_t PIN_FPGA_CDONE  = 26; // FPGA CDONE - corrected per schematic
